  ...
  return (
    <div>
        <div className="flex justify-center content-center w-100% mt-10 mb-10"> 
            <form className="flex flex-col justify-center bg-gray-200 p-15 rounded-2xl w-100 h-auto text-black" onSubmit={handleRegister}>
                <h1 className="text-4xl font-bold text-center -mt-5 mb-10">Register</h1>
                <label className="text-xl" htmlFor="text">Name:</label>
                <input className="text-lg border p-2 bg-white text-black rounded-lg mb-5" type="name" placeholder='Enter your name' onChange={e => setName(e.target.value)} required/>
                <label className="text-xl" htmlFor="text">Email:</label>
                <input className="text-lg border p-2 bg-white text-black rounded-lg mb-5" type="email" placeholder='Enter your email' onChange={e => setEmail(e.target.value)} required/>
                <label className="text-xl" htmlFor="">Password:</label>
                <input className="text-lg border p-2 bg-white text-black rounded-lg mb-5" type="password" placeholder='Enter your password' onChange={e => setPassword(e.target.value)} required/>
                <label className="text-xl" htmlFor="">Password Confirmation:</label>
                <input className="text-lg border p-2 bg-white text-black rounded-lg mb-5" type="password" placeholder='Re-enter password' onChange={e => setPasswordConfirmation(e.target.value)} required/>
